...
sb.glue("res_1%_Obf-1000Users-epoch50", res_syn)

model_path = os.path.join(data_path, "model_1%_Obf-1000Users-epoch50")#_1%Obf
os.makedirs(model_path, exist_ok=True)

model.model.save_weights(os.path.join(model_path, "nrms_ckpt_1%_Obf-1000Users-epoch50"))

group_impr_indexes, group_labels, group_preds = model.run_fast_eval(valid_news_file, valid_behaviors_file)

with open(os.path.join(data_path, 'NRMS_predictions/res_1%_Obf-1000Users/prediction_1000_users_epochs50_1%_Obf.txt'), 'w') as f:
...
data_path= '/export/scratch2/home/manel/RecSys_News/MIND/Version_Mind_small-Demo/NRMS_predictions/res_1%_Obf-1000Users/'
