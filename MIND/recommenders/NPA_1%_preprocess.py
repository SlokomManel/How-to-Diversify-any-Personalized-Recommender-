...
wordEmb_file = "/export/scratch2/home/manel/RecSys_News/MIND/Version_Mind_small-Demo/utils/embedding_all.npy" # os.path.join(data_path, "utils", "embedding.npy")
...
wordDict_file = "/export/scratch2/home/manel/RecSys_News/MIND/Version_Mind_small-Demo/utils/word_dict_all.pkl" # os.path.join(data_path, "utils", "word_dict.pkl")
yaml_file = "/export/scratch2/home/manel/RecSys_News/MIND/Version_Mind_small-Demo/utils/npa.yaml" # os.path.join(data_path, "utils", r'npa.yaml')
...
sb.glue("res_1%_Obf-1000Users-epoch50-npa", res_syn)

model_path = os.path.join(data_path, "model_1%_Obf-1000Users-epoch50-npa")#_1%Obf
os.makedirs(model_path, exist_ok=True)

model.model.save_weights(os.path.join(model_path, "NPA_ckpt_1%_Obf-1000Users-epoch50"))

group_impr_indexes, group_labels, group_preds = model.run_fast_eval(valid_news_file, valid_behaviors_file)

with open(os.path.join(data_path, 'NPA_predictions/res_1%_Obf-1000Users/prediction_1000_users_epochs50_1%_Obf.txt'), 'w') as f:
...
data_path= '/export/scratch2/home/manel/RecSys_News/MIND/Version_Mind_small-Demo/NPA_predictions/res_1%_Obf-1000Users/'
